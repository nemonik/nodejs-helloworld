...
docker run --rm --net="host" -e AWS_ACCESS_KEY_ID=xxxxxxxxx -e AWS_SECRET_ACCESS_KEY=xxxxxxxxx --volumes-from drone-data --volumes-from gogs-data --name gogs-drone-backup nemonik/gogs-drone-backup 
